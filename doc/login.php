...
else
{
	...
	if (isset($_POST["subMem"])) 
	{
		...
		{
			$_SESSION["loginMsg"]="Username does not exists";
		}
	}
	else
	{
...
?>		
	...
	<form class="form-horizontal reg-form" action="#" method="post">
		...
		<div class="form-group form-group-md">
			<label class="col-md-2 control-label">Password</label>
				<div class="col-sm-6">
				<input required id="password" class="form-control" type="password" placeholder="ex: 1q2w3e4e" maxlength="20" name="u_password">
				</div>
		</div>
		<div class="form-group form-group-md">
			<label class="col-md-2 control-label">Re-Type Password</label>
				<div class="col-sm-6">
				<input required id="confirm_password" class="form-control" type="password" placeholder="ex: 1q2w3e4e" maxlength="20" name="u_rpassword">
				</div>
		</div>
		<div class="form-group form-group-md">
